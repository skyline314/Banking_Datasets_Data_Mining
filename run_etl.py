...
Optional flags:
    ...
    --categorical path/to/custom_clean_categorical.csv
"""
...
from config.config import RAW_DATA_PATH, PROCESSED_DATA_PATH, CATEGORICAL_DATA_PATH
...
def parse_args():
    ...
    parser.add_argument(
        "--categorical",
        type=Path,
        default=CATEGORICAL_DATA_PATH,
        help=f"Path for categorical CSV output (default: {CATEGORICAL_DATA_PATH})",
    )
